...
const replaceTargetCellEnd = 'onclick="app.openNewCorsoModal(${d}, \\'${hour}\\')">`;';
...
const cEnd = html.indexOf(replaceTargetCellEnd, cStart);
if (cStart !== -1 && cEnd !== -1) {
    ...
    html = html.substring(0, cStart) + newCell + html.substring(cEnd + replaceTargetCellEnd.length);
