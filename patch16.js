...
const pasteDayStart = html.indexOf('pasteDay(targetDayOfWeek) {');
const clearCopiedDayStart = html.indexOf('clearCopiedDay() {');

if (pasteDayStart === -1 || clearCopiedDayStart === -1) {
...
html = html.substring(0, pasteDayStart) + fix + html.substring(clearCopiedDayStart);
fs.writeFileSync('index.html', html);
console.log('Successfully replaced pasteDay.');
